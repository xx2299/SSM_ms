%  Read SSM_n of three frequency ranges for all models
cd('E:\Manuscript\data\model\SSM_n')
namelist=dir('E:\Manuscript\data\model\SSM_n\*.mat');
len=length(namelist);
for i=1:len
...
save('E:\Manuscript\Figure\6\data\100\AVG_lat_avg1_100','AVG_lat_avg1_100')
save('E:\Manuscript\Figure\6\data\100\AVG_lat_avg2_100','AVG_lat_avg2_100')
save('E:\Manuscript\Figure\6\data\100\AVG_lat_avg3_100','AVG_lat_avg3_100')
save('E:\Manuscript\Figure\6\data\100\AVG_lat_std1_100','AVG_lat_std1_100')
save('E:\Manuscript\Figure\6\data\100\AVG_lat_std2_100','AVG_lat_std2_100')
save('E:\Manuscript\Figure\6\data\100\AVG_lat_std3_100','AVG_lat_std3_100')
save('E:\Manuscript\Figure\6\data\80\AVG_lat_avg1_80','AVG_lat_avg1_80')
save('E:\Manuscript\Figure\6\data\80\AVG_lat_avg2_80','AVG_lat_avg2_80')
save('E:\Manuscript\Figure\6\data\80\AVG_lat_avg3_80','AVG_lat_avg3_80')
save('E:\Manuscript\Figure\6\data\80\AVG_lat_std1_80','AVG_lat_std1_80')
save('E:\Manuscript\Figure\6\data\80\AVG_lat_std2_80','AVG_lat_std2_80')
save('E:\Manuscript\Figure\6\data\80\AVG_lat_std3_80','AVG_lat_std3_80')
% save('E:\Manuscript\Figure\6\data\AVG_lat_avg1','AVG_lat_avg1')
% save('E:\Manuscript\Figure\6\data\AVG_lat_avg2','AVG_lat_avg2')
% save('E:\Manuscript\Figure\6\data\AVG_lat_avg3','AVG_lat_avg3')
% save('E:\Manuscript\Figure\6\data\AVG_lat_std1','AVG_lat_std1')
% save('E:\Manuscript\Figure\6\data\AVG_lat_std2','AVG_lat_std2')
% save('E:\Manuscript\Figure\6\data\AVG_lat_std3','AVG_lat_std3')
% save('E:\Manuscript\Figure\6\data\SMAP_lat_avg1','SMAP_lat_avg1')
% save('E:\Manuscript\Figure\6\data\SMAP_lat_avg2','SMAP_lat_avg2')
% save('E:\Manuscript\Figure\6\data\SMAP_lat_avg3','SMAP_lat_avg3')
...
% mF1(SMAP_mean_SM<0.1)=nan;
% mF2(SMAP_mean_SM<0.1)=nan;
% mF3(SMAP_mean_SM<0.1)=nan;
...
% count=1;
% for i=1:406
%     lat_avg1(count,1)=nanmean(mF1(i,:));
%     count=count+1;
% end
% lat_avg2(406,1)=0;
% count=1;
% for i=1:406
%     lat_avg2(count,1)=nanmean(mF2(i,:));
%     count=count+1;
% end
% lat_avg3(406,1)=0;
% count=1;
% for i=1:406
%     lat_avg3(count,1)=nanmean(mF3(i,:));
%     count=count+1;
% end
